        ...
        <div class="" id="topsite">
            <div class="clearfix">
                <ul id="sites-apec">
                    ...
                    <li class="topBarActive">Jeunes Diplômés<span>|</span></li>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li id="onglet2"><a href="/Emploi-stage/Mes-services-Apec">Les Services<br class="hidden-xs hidden-sm" /> Apec</a></li>
                                    ...
                                    <li id="onglet5"><a href="/Emploi-stage/Premier-job">Premier<br class="hidden-xs hidden-sm" /> job</a></li>
                                    <li id="onglet6"><a href="/Emploi-stage/Observatoire-de-l-emploi">Observatoire<br class="hidden-xs hidden-sm" /> de l'emploi</a></li>
