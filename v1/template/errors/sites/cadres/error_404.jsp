...
<body id="cadres" class="error-page"
        ...
        <div class="" id="topsite">
            <div class="clearfix">
                <ul id="sites-apec">
                    ...
                    <li class="topBarActive">Cadres<span>|</span></li>
                    <li><a href="https://jd.apec.fr">Jeunes Diplômés</a><span>|</span></li>
                    <li><a href="https://recruteurs.apec.fr">Recruteurs</a></li>
                </ul>
            </div>
        </div><!--/topsite-->
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav">
                                    <li id="onglet1" class=""><a href="/home.html">Accueil</a></li>
                                    <li id="onglet2"><a href="/Emploi/Mes-services-Apec">Les Services<br class="hidden-xs hidden-sm" /> Apec</a></li>
                                    <li id="onglet3"><a href="/home/mes-offres.html">Mes<br class="hidden-xs hidden-sm" /> offres</a></li>
                                    <li id="onglet4"><a href="/home/mes-outils.html">Mes<br class="hidden-xs hidden-sm" /> outils</a></li>
                                    <li id="onglet5"><a href="/Emploi/Ma-carriere">Ma<br class="hidden-xs hidden-sm" /> carrière</a></li>
                                    <li id="onglet6"><a href="/Emploi/Observatoire-de-l-emploi">Observatoire<br class="hidden-xs hidden-sm" /> de l'emploi</a></li>
                                    <li id="onglet7"><a href="/home/communaute.html">Communauté</a></li>
                                    <li id="onglet8"><a href="/home/reseau-pro.html">Réseau<br class="hidden-xs hidden-sm" /> Pro</a></li>
                                    <li id="onglet9"><a href="/home/mon-compte.html">Mon<br class="hidden-xs hidden-sm" /> compte</a></li>
                                </ul>
                            </div><!-- /.navbar-collapse -->
                        </div><!-- /.container-fluid -->
                    </nav>
